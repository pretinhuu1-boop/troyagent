const DEFAULT_TAGLINE = "Todas as suas vendas, um Troy Vape.";
...
const TAGLINES: string[] = [
  ...
  "Bem-vindo ao Troy Vape: onde o estoque gira e os lucros decolam.",
  ...
  "Falo fluentemente vendas, zero burocracia e energia agressiva de faturamento.",
  ...
  "Me dê um pedido e eu te dou menos abas, menos esforço e mais lucro.",
  ...
  "Rodo local, remoto ou puramente no vapor—resultados variam com o estoque.",

...
export const SECTION_META: Record<string, { label: string; description: string }> = {
  env: {
    ...
    description: "Variáveis de ambiente passadas para o processo do gateway",
  },
  update: { label: "Atualizações", description: "Configurações de atualização automática e canal de lançamento" },
  ...
  messages: { label: "Mensagens", description: "Configurações de manuseio e roteamento de mensagens" },
  commands: { label: "Comandos", description: "Comandos de barra personalizados" },
  hooks: { label: "Ganchos (Hooks)", description: "Webhooks e ganchos de eventos" },
  ...
  wizard: { label: "Assistente de Instalação", description: "Estado e histórico do assistente de instalação" },
  // Additional sections
  ...
  bindings: { label: "Vínculos", description: "Vínculos de teclas e atalhos" },
  broadcast: { label: "Transmissão", description: "Configurações de transmissão e notificação" },
  audio: { label: "Áudio", description: "Configurações de entrada/saída de áudio" },
  session: { label: "Sessão", description: "Gerenciamento de sessão e persistência" },
  cron: { label: "Cron", description: "Tarefas agendadas e automação" },
  web: { label: "Web", description: "Servidor web e configurações de API" },
  ...
  talk: { label: "Falar", description: "Configurações de voz e fala" },
...
export function renderConfigForm(props: ConfigFormProps) {
  if (!props.schema) {
    return html`
      <div class="muted">Esquema indisponível.</div>
    `;
  }
  ...
  if (schemaType(schema) !== "object" || !schema.properties) {
    return html`
      <div class="callout danger">Esquema não suportado. Use Bruto.</div>
    `;
  }
    ...
    return html`
      <div class="config-empty">
        ...
        <div class="config-empty__text">
          ${searchQuery ? `Nenhuma configuração corresponde a "${searchQuery}"` : "Nenhuma configuração nesta seção"}
        </div>
      </div>
    `;
  }

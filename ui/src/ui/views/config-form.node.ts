...
export function renderNode(params: {
  ...
  if (unsupported.has(key)) {
    return html`<div class="cfg-field cfg-field--error">
      ...
      <div class="cfg-field__error">Esquema não suportado. Use modo Bruto.</div>
    </div>`;
  }
  ...
  return html`
    <div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${label}</div>
      <div class="cfg-field__error">Tipo não suportado: ${type}. Use modo Bruto.</div>
    </div>
  `;
}
...
function renderSelect(params: {
  ...
  return html`
    <div class="cfg-field">
      ...
      >
        <option value=${unset}>Selecione...</option>
        ${options.map(
          (opt, idx) => html`
...
function renderArray(params: {
  ...
  if (!itemsSchema) {
    return html`
      <div class="cfg-field cfg-field--error">
        <div class="cfg-field__label">${label}</div>
        <div class="cfg-field__error">Esquema de array não suportado. Use modo Bruto.</div>
      </div>
    `;
  }
  ...
  return html`
    <div class="cfg-array">
      ...
      ${
        arr.length === 0
          ? html`
              <div class="cfg-array__empty">Nenhum item ainda. Clique em "Adicionar" para criar.</div>
            `
          : html`
  ...
  return html`
    <div class="cfg-map">
      <div class="cfg-map__header">
        <span class="cfg-map__label">Entradas personalizadas</span>
        <button
          type="button"
          class="cfg-map__add"
          ?disabled=${disabled}
      ...
      ${
        entries.length === 0
          ? html`
              <div class="cfg-map__empty">Nenhuma entrada personalizada.</div>
            `
          : html`

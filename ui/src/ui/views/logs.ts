    ...
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          ...
          <div class="card-sub">Logs de arquivo do Gateway (JSONL).</div>
        </div>
      ...
      ${
        props.file
          ? html`<div class="muted" style="margin-top: 10px;">Arquivo: ${props.file}</div>`
          : nothing
      }
      ${
        props.truncated
          ? html`
              <div class="callout" style="margin-top: 10px">Saída de log truncada; mostrando trecho recente.</div>
            `
          : nothing
      }
      ${
      ...
      <div class="log-stream" style="margin-top: 12px;" @scroll=${props.onScroll}>
        ${
          filtered.length === 0
            ? html`
                <div class="muted" style="padding: 12px">Nenhum registro de log.</div>
              `
            : filtered.map(
                (entry) => html`
                <div class="log-row">

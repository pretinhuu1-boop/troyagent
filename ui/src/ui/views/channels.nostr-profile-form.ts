  ...
  return html`
    <div class="nostr-profile-form" style="padding: 16px; background: var(--bg-secondary); border-radius: 8px; margin-top: 12px;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        <div style="font-weight: 600; font-size: 16px;">Editar Perfil</div>
        <div style="font-size: 12px; color: var(--text-muted);">Conta: ${accountId}</div>
      </div>
      ...
      ${renderField("name", "Nome de usuário", {
      placeholder: "satoshi",
      maxLength: 256,
      help: "Nome de usuário curto (ex: satoshi)",
    })}

      ${renderField("displayName", "Nome de exibição", {
      placeholder: "Satoshi Nakamoto",
      maxLength: 256,
      help: "Seu nome de exibição completo",
    })}

      ${renderField("about", "Bio", {
      type: "textarea",
      placeholder: "Conte para as pessoas sobre você...",
      maxLength: 2000,
      help: "Uma breve bio ou descrição",
    })}

      ${renderField("picture", "URL do Avatar", {
      type: "url",
      placeholder: "https://example.com/avatar.jpg",
      help: "URL HTTPS para sua foto de perfil",
    })}

      ${state.showAdvanced
      ? html`
            <div style="border-top: 1px solid var(--border-color); padding-top: 12px; margin-top: 12px;">
              <div style="font-weight: 500; margin-bottom: 12px; color: var(--text-muted);">Avançado</div>

              ${renderField("banner", "URL do Banner", {
        type: "url",
        placeholder: "https://example.com/banner.jpg",
        help: "URL HTTPS para uma imagem de banner",
      })}

              ${renderField("website", "Website", {
        type: "url",
        placeholder: "https://example.com",
        help: "Seu site pessoal",
      })}

              ${renderField("nip05", "Identificador NIP-05", {
        placeholder: "voce@exemplo.com",
        help: "Identificador verificável (ex: voce@dominio.com)",
      })}

              ${renderField("lud16", "Endereço Lightning", {
        placeholder: "voce@getalby.com",
        help: "Endereço Lightning para gorjetas (LUD-16)",
      })}
            </div>
          `
      : nothing
      ...
      <div style="display: flex; gap: 8px; margin-top: 16px; flex-wrap: wrap;">
        ...
        >
          ${state.saving ? "Salvando..." : "Salvar e Publicar"}
        </button>
        ...
        >
          ${state.importing ? "Importando..." : "Importar dos Relays"}
        </button>
        ...
        >
          ${state.showAdvanced ? "Ocultar Avançado" : "Mostrar Avançado"}
        </button>

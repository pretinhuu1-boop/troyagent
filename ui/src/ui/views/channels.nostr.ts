          ...
          hasAnyProfileData
            ? html`
              <div class="status-list">
                ...
                ${name ? html`<div><span class="label">Nome</span><span>${name}</span></div>` : nothing}
                ${
                  displayName
                    ? html`<div><span class="label">Nome de Exibição</span><span>${displayName}</span></div>`
                    : nothing
                }
                ${
                  about
                    ? html`<div><span class="label">Sobre</span><span style="max-width: 300px; overflow: hidden; text-overflow: ellipsis;">${about}</span></div>`
                    : nothing
                }

  ...
  return html`
    ...
    <section class="card" style="margin-top: 18px;">
      <div class="row" style="justify-content: space-between;">
        <div>
          <div class="card-title">Saúde dos Canais</div>
          <div class="card-sub">Status dos canais obtidos do gateway.</div>
        </div>
  ...
  return html`
    <div class="account-card">
      ...
      <div class="status-list account-card-status">
        <div>
          <span class="label">Rodando</span>
          <span>${runningStatus === "Active" ? "Ativo" : runningStatus === "Yes" ? "Sim" : "Não"}</span>
        </div>
        <div>
          <span class="label">Configurado</span>
        ...
        <div>
          <span class="label">Conectado</span>
          <span>${connectedStatus === "Active" ? "Ativo" : connectedStatus === "Yes" ? "Sim" : connectedStatus === "No" ? "Não" : "n/a"}</span>
        </div>
        <div>

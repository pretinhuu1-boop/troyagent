...
export function renderApp(state: AppViewState) {
  ...
  const chatDisabledReason = state.connected ? null : "Desconectado do gateway.";
    ...
    <div class="shell ${isChat ? "shell--chat" : ""} ${chatFocus ? "shell--chat-focus" : ""} ${state.settings.navCollapsed ? "shell--nav-collapsed" : ""} ${state.onboarding ? "shell--onboarding" : ""}">
      ...
      state.applySettings({
        ...
        navCollapsed: !state.settings.navCollapsed,
            ...
            title="${state.settings.navCollapsed ? "Expandir barra lateral" : "Recolher barra lateral"}"
            aria-label="${state.settings.navCollapsed ? "Expandir barra lateral" : "Recolher barra lateral"}"
          >
            <span class="nav-collapse-toggle__icon">${icons.menu}</span>
          </button>
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"} alt="Troy Vape" />
            </div>
            <div class="brand-text">
              <div class="brand-title">TROY VAPE</div>
      ...
      <aside class="nav ${state.settings.navCollapsed ? "nav--collapsed" : ""}">
        ...
        <div class="nav-group nav-group--links">
          <div class="nav-label nav-label--static">
            <span class="nav-label__text">Recursos</span>
          </div>
          <div class="nav-group__items">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              title="Documentação (abre em nova aba)"
            >

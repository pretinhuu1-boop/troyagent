...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    comando: "Central de operacoes: agentes, pipeline, decisoes e metricas.",
    ...
    conteudo: "Artigos, blog, calendario editorial e sincronizacao.",
    social: "Campanhas, agendamento e gestao de redes sociais.",
    gerador: "Estudio AI para criacao de imagens, videos e conteudo visual.",
    agents: "Gerenciar espaços de trabalho, ferramentas e identidades de agentes.",
    "mission-board": "Criar, gerenciar e acompanhar missoes dos agentes.",
    "war-room": "Visao geral dos agentes, pipeline de tarefas e atividade.",

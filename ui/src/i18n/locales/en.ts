...
export const en: TranslationMap = {
  ...
  subtitles: {
    comando: "Operations center: agents, pipeline, decisions and metrics.",
    ...
    conteudo: "Articles, blog, editorial calendar, and sync.",
    social: "Campaigns, scheduling, and social media management.",
    gerador: "AI studio for creating images, videos, and visual content.",
    agents: "Manage agent workspaces, tools, and identities.",
    "mission-board": "Create, manage, and track agent missions.",
    "war-room": "Agent overview, task pipeline, and activity summary.",
